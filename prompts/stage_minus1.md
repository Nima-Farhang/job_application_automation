...
Your task is to analyse the job description and extract what the recruiter is actually hiring for.

Do NOT rewrite the CV in this step.
...
These must be real keywords used in the job ad.
